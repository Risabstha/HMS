...
$errors = array();
    ...
    if(isset($_POST['check-reset-otp'])){
      ...
      $check_code = "SELECT * FROM doctb WHERE code = $otp_code";
      ...
      if(mysqli_num_rows($code_res) > 0){
          ...
          $_SESSION['info'] = $info;
          header('location: docNewPassword.php');
          exit();
      }else{
        ...
        <div class="row">
            ...
            <div class="col-md-6 register-right" style="margin-top:5%; margin-left:15%; ">
                ...
                <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <h3 class="register-heading">Code Verification</h3>
                    <form method="post" action="docResetCode.php">
                        ...
                        <?php 
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    placeholder="Enter code.." name="otp" required value="<?php echo $email ?>" />

                                </div>

                            </div>
                                <input type="submit" class="btnRegister" style="margin-top: 4%; margin-left:25%;" name="check-reset-otp" value="submit" />
